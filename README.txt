...
## How to setup Acclaim API 

The Acclaim plugin will allow students earn badges once they complete a course on moodle. To read more about course completion setup on the moodle site, please refer to this link -> https://docs.moodle.org/dev/Course_completion

The following field must be entered under plugin settings in order to issue badge successfully:

api: web service API request, which can be found at  https://jefferson-staging.herokuapp.com/docs/web_service_api

Organization ID: The organization you are representing to issue badge

Token: Organization token, which can be found under organization management->Developer tools->Authorization token

Badge Template Id: The specific badge you want to issue to student once they complete course 
